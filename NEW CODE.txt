...
c=imcrop(g,[138 96 787 402]);
subplot(1,2,1);
imshow(c);
title('STEP:5 Cropped Image:1');

cc=imcrop(gg,[14 2 500 276]);
subplot(1,2,2);
imshow(cc);
...
subplot(1,2,1);
imshow(g);
[centersiris1, radiiiris1] = imfindcircles(g,[74 75],'ObjectPolarity','dark', 'Sensitivity',0.99,'EdgeThreshold',0.1,'Method','TwoStage');
[centerspupil1, radiipupil1] = imfindcircles(g,[35 36],'ObjectPolarity','dark', 'Sensitivity',0.96,'EdgeThreshold',0.1,'Method','TwoStage');
...
subplot(1,2,2);
imshow(gg);
[centersiris2, radiiiris2] = imfindcircles(gg,[53 54],'ObjectPolarity','dark', 'Sensitivity',0.98,'EdgeThreshold',0.1,'Method','TwoStage');
[centerspupil2, radiipupil2] = imfindcircles(gg,[15 16],'ObjectPolarity','dark', 'Sensitivity',0.96,'EdgeThreshold',0.1,'Method','TwoStage');
